export const dictionary = {
  ...
  fable: "To compose fables; hence, to write or speak fiction ; to writeor utter what is not true. \"He Fables not.\" Shak.Vain now the tales which fabling poets tell. Prior.He fables, yet speaks truth. M. Arnold.",
  ...
  facia: "See Fascia.",
  faded: "That has lost freshness, color, or brightness; grown dim. \"Hisfaded cheek.\" Milton.Where the faded moon Made a dim silver twilight. Keats.",
  faery: "Fairy. [Archaic] Spenser.",
  fagot: "A bassoon. See Fagotto.",
  faint: "The act of fainting, or the state of one who has fainted; aswoon. [R.] See Fainting, n.The saint, Who propped the Virgin in her faint. Sir W. Scott.",
  ...
  feint: "Feigned; counterfeit. [Obs.]Dressed up into any feint appearance of it. Locke.",
  felon: "A person who has committed a felony.",
  fence: "A projection on the bolt, which passes through the tumblergates in locking and unlocking.",
  fenny: "Pertaining to, or inhabiting, a fen; abounding in fens; swampy;boggy. \"Fenny snake.\" Shak.",
  feral: "Wild; untamed; ferine; not domesticated; -- said of beasts,birds, and plants. feral child, not raised by humans",
  ferny: "Abounding in ferns.",
  ferry: "To carry or transport over a river, strait, or other narrowwater, in a boat.",
  fetal: "Pertaining to, or connected with, a fetus; as, fetalcirculation; fetal membranes.",
  ...
  fiche: "See FitchÉ.",
  fichu: "A light cape, usually of lace, worn by women, to cover the neckand throat, and extending to the shoulders.",
  ficus: "A genus of trees or shrubs, one species of which (F. Carica)produces the figs of commerce; the fig tree.",
  field: "The whole surface of an escutcheon; also, so much of it isshown unconcealed by the different bearings upon it. See Illust. ofFess, where the field is represented as gules (red), while the fessis argent (silver).",
  fiend: "An implacable or malicious foe; one who is diabolically wickedor cruel; an infernal being; -- applied specifically to the devil ora demon.Into this wild abyss the wary fiend Stood on the brink of Hell andlooked a while. Milton.O woman! woman! when to ill thy mind Is bent, all hell contains nofouler fiend. Pope.",
  fifer: "One who plays on a fife.",
  fifth: "The interval of three tones and a semitone, embracing fivediatonic degrees of the scale; the dominant of any key.",
  fifty: "Five times ten; as, fifty men.",
  filch: "To steal or take privily (commonly, that which is of littlevalue); to pilfer.Fain would they filch that little food away. Dryden.But he that filches from me my good name, Robs me of that which notenriches him, And makes me poor indeed. Shak.",
  filer: "One who works with a file.",
  filly: "A female foal or colt; a young mare. Cf. Colt, Foal.Neighing in likeness of a filly foal. Shak.",
  filmy: "Composed of film or films.Whose filmy cord should bind the struggling fly. Dryden.",
  finch: "A small singing bird of many genera and species, belonging tothe family Fringillidæ.",
  ...
  flame: "To kindle; to inflame; to excite.And flamed with zeal of vengeance inwardly. Spenser.",
  flank: "That part of a bastion which reaches from the curtain to theface, and defends the curtain, the flank and face of the oppositebastion; any part of a work defending another by a fire along theoutside of its parapet. See Illust. of Bastion.",
  flare: "Leaf of lard. \"Pig's flare.\" Dunglison.",
  flash: "To cover with a thin layer, as objects of glass with glass of adifferent color. See Flashing, n., 3 (b).",
  ...
  flick: "To whip lightly or with a quick jerk; to flap; as, to flick ahorse; to flick the dirt from boots. Thackeray.",
  flier: "A fly. See Fly, n., 9, and 13 (b).",
  flint: "A massive, somewhat impure variety of quartz, in color usuallyof a gray to brown or nearly black, breaking with a conchoidalfracture and sharp edge. It is very hard, and strikes fire withsteel.",
  flirt: "One who flirts; esp., a woman who acts with giddiness, or playsat courtship; a coquette; a pert girl.Several young flirts about town had a design to cast us out of thefashionable world. Addison.",
  float: "A contrivance for affording a copious stream of water to theheated surface of an object of large bulk, as an anvil or die.Knight.",
  flock: "To gather in companies or crowds.Friends daily flock. Dryden.Flocking fowl (Zoöl.), the greater scaup duck.",
  ...
  flour: "The finely ground meal of wheat, or of any other grain;especially, the finer part of meal separated by bolting; hence, thefine and soft powder of any substance; as, flour of emery; flour ofmustard. Flour bolt, in milling, a gauze-covered, revolving,cylindrical frame or reel, for sifting the flour from the refusecontained in the meal yielded by the stones.-- Flour box a tin box for scattering flour; a dredging box.-- Flour dredge or dredger, a flour box.-- Flour dresser, a mashine for sorting and distributing flouraccording to grades of fineness.-- Flour mill, a mill for grinding and sifting flour.",
  flout: "To mock or insult; to treat with contempt.Phillida flouts me. Walton.Three gaudy standarts lout the pale blue sky. Byron.",
  ...
  fluid: "Having particles which easily move and change their relativeposition without a separation of the mass, and which easily yield topressure; capable of flowing; liquid or gaseous.",
  fluke: "One of the lobes of a whale's tail, so called from theresemblance to the fluke of an anchor.",
  fluky: "Formed like, or having, a fluke.",
  flume: "A stream; especially, a passage channel, or conduit for thewater that drives a mill wheel; or an artifical channel of water forhydraulic or placer mining; also, a chute for conveying logs orlumber down a declivity.",
  ...
  flute: "A channel of curved section; -- usually applied to one of avertical series of such channels used to decorate columns andpilasters in classical architecture. See Illust. under Base, n.",
  fluty: "Soft and clear in tone, like a flute.",
  flyer: "One in a flight of steps which are parallel to each other(as inordinary stairs), as distinguished from a winder.",
  ...
  focus: "A point in which the rays of light meet, after being reflectedor refrcted, and at which the image is formed; as, the focus of alens or mirror.",
  fogey: "See Fogy.",
  foist: "A light and fast-sailing ship. [Obs.] Beau. & Fl.",
  folio: "The page number. The even folios are on the left-hand pages andthe odd folios on the right-hand.",
  fondu: "Blended; passing into each other by subtle gradations; -- saidof colors or of the surface or material on which the colors are laid.",
  ...
  forge: "To move heavily and slowly, as a ship after the sails arefurled; to work one's way, as one ship in outsailing another; -- usedespecially in the phrase to forge ahead. Totten.And off she [a ship] forged without a shock. De Quincey.",
  forgo: "To pass by; to leave. See 1st Forego.For sith [since] I shall forgoon my liberty At your request. Chaucer.And four [days] since Florimell the court forwent. Spenser.",
  ...
  frame: "To construct by fitting and uniting the several parts of theskeleton of any structure; specifically, in woodwork, to put togetherby cutting parts of one member to fit parts of another. See Dovetail,Halve, v. t., Miter, Tenon, Tooth, Tusk, Scarf, and Splice.",
  franc: "A silver coin of France, and since 1795 the unit of the Frenchmonetary system. It has been adopted by Belgium and Swizerland. It isequivalent to about nineteen cents, or ten pence, and is divided into100 centimes.",
  frank: "A pigsty. [Obs.]",
  fraud: "An intentional perversion of truth for the purpose of obtainingsome valuable thing or promise from another.",
  freak: "To variegate; to checker; to streak. [R.]Freaked with many a mingled hue. Thomson.",
  fresh: "To refresh; to freshen. [Obs.] Rom. of R.",
  freya: "The daughter of Njörd, aud goddess of love and beauty; theScandinavian Venus; -- in Teutonic myths confounded with Frigga, butin Scandinavian, distinct. [Written also Frea, Fraying, and Ereyja.]",
  friar: "A brother or member of any religious order, but especially ofone of the four mendicant orders, viz: (a) Minors, Gray Friars, orFranciscans. (b) Augustines. (c) Dominicans or Black Friars. (d)White Friars or Carmelites. See these names in the Vocabulary.",
  ...
  front: "Of or relating to the front or forward part; having a positionin front; foremost; as, a front view.",
  froth: "To throw up or out spume, foam, or bubbles; to foam; as beerfroths; a horse froths.",
  ...
  froze: "imp. of Freeze.",
  fruit: "The pulpy, edible seed vessels of certain plants, especiallythose grown on branches above ground, as apples, oranges, grapes,melons, berries, etc. See 3.",
  ...
  fully: "In a full manner or degree; completely; entirely; without lackor defect; adequately; satisfactorily; as, to be fully persuaded ofthe truth of a proposition. Fully committed (Law), committed toprison for trial, in distinction from being detained for examination.",
  fungi: "See Fungus.",
  ...
  furze: "A thorny evergreen shrub (Ulex Europæus), with beautiful yellowflowers, very common upon the plains and hills of Great Britain; --called also gorse, and whin. The dwarf furze is Ulex nanus.",
  ...
  fussy: "Making a fuss; disposed to make an unnecessary ado abouttrifles; overnice; fidgety.Not at all fussy about his personal appearance. R. G. White.",
  ...
  jacob: "A Hebrew patriarch (son of Isaac, and ancestor of the Jews),who in a vision saw a ladder reaching up to heaven (Gen. xxviii. 12);-- also called Israel.And Jacob said . . . with my staff I passed over this Jordan, and nowI am become two bands. Gen. xxxii. 9, 10.Thy name shall be called no more Jacob, but Israel. Gen. xxxii. 28.Jacob's ladder. (a) (Bot.) A perennial herb of the genus Polemonium(P. coeruleum), having corymbs of drooping flowers, usually blue.Gray. (b) (Naut.) A rope ladder, with wooden steps, for going aloft.R. H. Dana, Jr. (c) (Naut.) A succession of short cracks in adefective spar.-- Jacob's membrane. See Retina.-- Jacob's staff. (a) A name given to many forms of staff or weapon,especially in the Middle Ages; a pilgrim's staff. [Obs.] Spenser. (b)(Surveying) See under Staff.",
  jalap: "The tubers of the Mexican plant Ipomoea purga (or Exogoniumpurga), a climber much like the morning-glory. The abstract, extract,and powder, prepared from the tubers, are well known purgativemedicines. Other species of Ipomoea yield several inferior kinds ofjalap, as the I. Orizabensis, and I. tuberosa. False jalap, the rootof Mirabilis Jalapa, four-o'clock, or marvel of Peru.",
  janus: "A Latin deity represented with two faces looking in oppositedirections. Numa is said to have dedicated to Janus the coveredpassage at Rome, near the Forum, which is usually called the Templeof Janus. This passage was open in war and closed in peace. Dr. W.Smith. Janus cloth, a fabric having both sides dressed, the sidesbeing of different colors, -- used for reversible garments.",
  japan: "Work varnished and figured in the Japanese manner; also, thevarnish or lacquer used in japanning.",
  ...
  jesus: "The Savior; the name of the Son of God as announced by theangel to his parents; the personal name of Our Lord, in distinctionfrom Christ, his official appellation. Luke i. 31.Thou shalt call his name Jesus; for he shall save his people fromtheir sins. Matt. i. 21.",
  jetty: "Made of jet, or like jet in color.The people . . . are of a jetty. Sir T. Browne.",
  jewel: "To dress, adorn, deck, or supply with jewels, as a dress, asword hilt, or a watch; to bespangle, as with jewels.The long gray tufts . . . are jeweled thick with dew. M. Arnold.",
  ...
  joint: "A plane of fracture, or divisional plane, of a rock transverseto the stratification.",
  joist: "A piece of timber laid horizontally, or nearly so, to which theplanks of the floor, or the laths or furring strips of a ceiling, arenailed; -- called, according to its position or use, binding joist,bridging joist, ceiling joist, trimming joist, etc. See Illust. ofDouble-framed floor, under Double, a.",
  joker: "See Rest bower, under 2d Bower.",
  jolty: "That jolts; as, a jolty coach. [Colloq.]",
  jonah: "The Hebrew prophet, who was cast overboard as one whoendangered the ship; hence, any person whose presence isunpropitious. Jonah crab (Zoöl.), a large crab (Cancer borealis) ofthe eastern coast of the United States, sometimes found betweentides, but usually in deep water.",
  joule: "A unit of work which is equal to 107 units of work in the C. G.S. system of units (ergs), and is practically equivalent to theenergy expended in one second by an electric current of one ampere ina resistance of one ohm. One joule is approximately equal to 0.738foot pounds. Joule's equivalent. See under Equivalent, n.",
  joust: "To engage in mock combat on horseback, as two knights in thelists; to tilt. [Written also just.]For the whole army to joust and tourney. Holland.",
  judas: "The disciple who betrayed Christ. Hence: A treacherous person;one who betrays under the semblance of friendship.-- a.",
  ...
  julep: "a sweet, demulcent, acidulous, or mucilaginous mixture, used asa vehicle. Milton.Honey in woods, juleps in brooks. H. Vaughan.",
  ...
  junta: "A council; a convention; a tribunal; an assembly; esp., thegrand council of state in Spain.",
  junto: "A secret council to deliberate on affairs of government orpolitics; a number of men combined for party intrigue; a faction; acabal; as, a junto of ministers; a junto of politicians.The puzzling sons of party next appeared, In dark cabals and mightyjuntos met. Thomson.",
  juror: "A member of a jury; a juryman.I shall both find your lordship judge and juror. Shak.",
  ...
  pyxis: "A pyxidium.",
  quack: "A boastful pretender to medical skill; an empiric; an ignorantpractitioner.",
  ...
  yacht: "A light and elegantly furnished vessel, used either for privateparties of pleasure, or as a vessel of state to convey distinguishedpersons from one place to another; a seagoing vessel used only forpleasure trips, racing, etc. Yacht measurement. See the Note underTonnage, 4.",
  yahoo: "A modern transliteration of the Hebrew word translated Jehovahin the Bible; -- used by some critics to discriminate the tribal godof the ancient Hebrews from the Christian Jehovah. Yahweh or Yahwe isthe spelling now generally adopted by scholars.",
  yearn: "To pain; to grieve; to vex. [Obs.] \"She laments, sir, for it,that it would yearn your heart to see it.\" Shak.It yearns me not if men my garments wear. Shak.",
  yeast: "A form of fungus which grows as indvidual rounded cells, ratherthan in a mycelium, and reproduces by budding; esp. members of theorders Endomycetales and Moniliales. Some fungi may grow both as ayeast or as a mycelium, depending on the conditions of growth. Yeastcake, a mealy cake impregnated with the live germs of the yeastplant, and used as a conveniently transportable substitute for yeast.-- Yeast plant (Bot.), the vegetable organism, or fungus, of whichbeer yeast consists. The yeast plant is composed of simple cells, orgranules, about one three-thousandth of an inch in diameter, oftenunited into filaments which reproduce by budding, and under certaincircumstances by the formation of spores. The name is extended toother ferments of the same genus. See Saccharomyces.-- Yeast powder, a baling powder, -- used instead of yeast inleavening bread.",
  yield: "Amount yielded; product; -- applied especially to productsresulting from growth or cultivation. \"A goodly yield of fruit dothbring.\" Bacon.",
